...
?>
		<footer class="zomeex-footer">
			<div class="zomeex-container zomeex-footer__grid">
				...
				<div><p class="zomeex-footer__label">Start a brief</p><p>Share your target market, product family, and quantity.</p><a class="zomeex-footer__link" href="<?php echo esc_url( zomeex_page_url( 'contact-us', '/contact-us/' ) ); ?>">Request a quote <span aria-hidden="true">↗</span></a></div>
			</div>
