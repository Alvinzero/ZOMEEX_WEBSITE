...
?>
		<footer class="zomeex-footer">
			<div class="zomeex-container zomeex-footer__grid">
				...
				<div><p class="zomeex-footer__label">Explore</p><a href="<?php echo esc_url( zomeex_home_url( '/shop/' ) ); ?>">Products</a><a href="<?php echo esc_url( zomeex_page_url( 'about-us-3', '/about-us-3/' ) ); ?>">About</a><a href="<?php echo esc_url( zomeex_page_url( 'news', '/news/' ) ); ?>">Insights</a><a href="<?php echo esc_url( function_exists( 'zomeex_faq_url' ) ? zomeex_faq_url() : zomeex_home_url( '/faq/' ) ); ?>">FAQ</a></div>
